...
class Bot(commands.Cog):
  ...
  async def botinfo(self, ctx):
    ...
    embed.add_field(name = "Creator <:Bot_owner:903494195975684127> <:Bot_dev:903502947290333245>", value = "username#2575")
    ...
    embed.add_field(name = "This bot was created at:", value = self.bot.user.created_at.strftime("%m/%d/%Y, %H:%M:%S UTC"), inline=False)
